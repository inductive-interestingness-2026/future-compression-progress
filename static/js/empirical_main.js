document.addEventListener("DOMContentLoaded", () => {
    ...
    // 1. Tag Machine Init
    new StairCurveVisualizer("#tag-vis", "tag_curves.json", {
        horizons: [2, 5, 10],
    ...
    // 2. Rule 110 Init
    new StairCurveVisualizer("#rule110-vis", "rule110_curves.json", {
    ...
    // 3. Brainfuck Init
    new StairCurveVisualizer("#bf-vis", "bf_curves.json", {
        horizons: [50, 100, 200],
        onProgramSelect: (pStr) => {
